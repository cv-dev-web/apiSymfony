 ...
 */
final class Version20220615075454 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resource CHANGE status_id status_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resource CHANGE status_id status_id INT DEFAULT NULL');
